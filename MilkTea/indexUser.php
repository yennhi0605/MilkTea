  ...
  <div class="slideshow-container" style="margin-top: 20px">
    ...
    <div class="menu">
      ...
      <form action="cart.php" class="cart">
       <button onclick="cart()" style="background-color: sandybrown">
  ...
  <div class="milk-container">
    ...
    <div class="item-milk">
      ...
      <form action="detail.php" method="get" class="btn">
        <button name="detail" style="background-color: sandybrown" onclick="detail(<?php echo $milkteas[$i]->id; ?>)">Detail</button>
      </form>
      <form action="" method="post" class="btn">
       <button name="order" style="background-color: red">Order</button>
      </form>
    </div>
